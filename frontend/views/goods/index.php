            ...
            <ul>
                <?php
                    if (Yii::$app->user->isGuest){
                        $username = '<a href='.\yii\helpers\Url::to(['member/login']).'>请登录</a>';
                        echo '<li>您好，欢迎来到京西！[<a href="'.\yii\helpers\Url::to(['member/login']).'">登录</a>] [<a href="'.\yii\helpers\Url::to(['member/sign-up']).'">免费注册</a>] </li>';
                    }else{
                        $username = Yii::$app->user->identity->username;
                        echo " <li>您好，欢迎".$username."来到京西！[<a href=".\yii\helpers\Url::to(['member/logout']).">退出</a>]</li>";
                    }
                ?>
                <li class="line">|</li>
                <li>我的订单</li>
...
<div class="bottomnav w1210 bc mt10">
    ...
    <div class="bnav1">
        ...
        <ul>
            <?php foreach (\frontend\models\Article::getArticle($category['id']) as $title):?>
