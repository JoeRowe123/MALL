...
<div class="topnav">
    <div class="topnav_bd w990 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>您好，欢迎来到京西！[<a href="<?=\yii\helpers\Url::to('/member/login')?>.html">登录</a>] [<a href="<?=\yii\helpers\Url::to(['member/sign-up'])?>">免费注册</a>] </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
...
<div class="login w990 bc mt10">
    ...
    <div class="login_bd">
        <div class="login_form fl">
            <form id="login_form" action="<?=\yii\helpers\Url::to(['member/login'])?>" method="post">
                <ul>
                    <li>
                        <label for="">用户名：</label>
        ...
        <div class="guide fl">
            ...
            <a href="<?=\yii\helpers\Url::to('/member/sign-up')?>.html" class="reg_btn">免费注册 >></a>
        </div>
