...
<div class="topnav">
    <div class="topnav_bd w990 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>您好，欢迎来到京西！[<a href="<?=\yii\helpers\Url::to(['member/login'])?>">登录</a>] [<a href="<?=\yii\helpers\Url::to(['member/sign-up'])?>">免费注册</a>]> </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
...
<div class="login w990 bc mt10 regist">
    ...
    <div class="login_bd">
        <div class="login_form fl">
            <form action="<?=\yii\helpers\Url::to(['member/sign-up'])?>" id="sign_form" method="post">
                <ul>
                    <li>
                        <label for="">用户名：</label>
...
//                    minlength: "密码长度不能小于 5 个字母",
    ...
    function bindPhoneNum(){
        ...
        if (reg.test(tel)){
            $.post("<?=\yii\helpers\Url::to(['member/sms'])?>",{tel:tel},function (data) {
                if(data == 'success'){
                    alert('短信发送成功');
                }else{
                    //发送失败
